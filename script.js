...
let explosions = [];
let score = 0;
let wave = 0; // start at 0 so first nextWave increments to 1
let minionsToAdd = [];
  ...
  if(enemies.length===0){
    ...
    if(wave===1) spawnEnemies(4);
      ...
      for(let i=0;i<triCount;i++){
        ...
        offsets.forEach(o=>enemies.push({x:triX+o.x,y:triY+o.y,size:30,speed:0,health:30,type:"shield",triId,i,offsetX:o.x,offsetY:o.y}));
      }
    }
